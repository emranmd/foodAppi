...
<main class="mainContent_area">
    <div class="container max-w-xl py-5">
        <div class="row">
            <div class="col-lg-12 col-md-12">
                <div class="information_content_area">
                    <h5 class="dz_title f-w600 f-s26">Cookies Policy</h5>
                    <p>This Cookies Policy explains how FoodAppi (“us”, “we” or “our”) collects, uses, stores, shares and uses cookies on its website. We provide information on how cookies and similar technologies work, their purpose, use, and duration, how We process and store them, and how you can control them. You can also find all the necessary information regarding your rights on the use of Cookies on this website and how you can exercise them.
                    ...
                    FoodAppi will only set cookies after you have provided your consent to the use of cookies through the cookies banner upon your visit to our website. For Necessary cookies, we do not need your consent.

                    You have the right to withdraw your consent or change your preferences regarding the use of cookies at any time. You can do this by accessing our Cookies banner through the “Cookie Settings” button.</p>
                </div>
                <div class="support_area">
                    <h5 class="dz_title">Support</h5>
                    <div class="d-flex align-items-center gap_5 mb-2">
                        <i class="fa-solid fa-envelope-open-text "></i>
                        <h6 class="m-0 f-s14">info@inilabs.net</h6>
                    </div>
                    <div class="d-flex align-items-center gap_5">
                        <i class="fa-solid fa-headset "></i>
                        <h6 class="m-0 f-w500">+12372349</h6>
                    </div>
                </div>
            </div>
        </div>
