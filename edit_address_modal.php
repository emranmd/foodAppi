<!-- Modal -->
<div class="modal fade addressModal" id="editAddressModal" tabindex="-1" aria-labelledby="editAddressModalLabel" aria-hidden="true">
      ...
      <div class="modal-body">
        <form action="" method="post">
            ...
            <div class="d-flex align-items-center mb-3">
                <span class="f-s14 text_cyan"><i class="fa fa-location-dot mr-1"></i></span>
                <p class="m-0 f-family-r f-s14" >Dhaka, Bangladesh</p>
            </div>
            <div class="formGroup mb-4">
                <label>Apartment & Flat No</label>
                <textarea name="apartment_no" class="form-control textareaStyle" rows="2">653, Gulshan 2</textarea>
            </div>
            <div class="address_typeArea">
                <h6 class="m-0 title">Add Label</h6>
                <div class="active_buttonGroup">
                    <div class="btnGroup">
                        <input type="radio" class="d-none" name="address_type" id="home" value="home" checked>
